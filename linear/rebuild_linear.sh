...
build_one 1 3 "Linear MILP search" "$REPO/linear/neoalzette_scip_round_milp_search.cpp" "$REPO/linear/neoalzette_scip_round_milp_search"
build_one 2 3 "Linear HULL search" "$REPO/linear/neoalzette_scip_round_hull_search.cpp" "$REPO/linear/neoalzette_scip_round_hull_search"
build_one 3 3 "Linear HULL multi-core runner" "$REPO/linear/hull_multiple_thread_runner.cpp" "$REPO/linear/hull_multiple_thread_runner"

echo
echo "Linear Linux build OK."
