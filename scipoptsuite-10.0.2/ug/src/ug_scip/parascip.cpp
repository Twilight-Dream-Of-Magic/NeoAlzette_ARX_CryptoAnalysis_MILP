...
{
   std::cout << std::endl;
   std::cout << "syntax: mpirun(command provided by MPI) #MPI_processes(#solvers + 1) " << argv[0] << " parascip_param_file problem_file_name "
...
//   std::cout << "TagKeepRacing == " << TagKeepRacing << std::endl;
//   std::cout << "TagTerminateSolvingToRestart == " << TagTerminateSolvingToRestart << std::endl;
//   std::cout << "TagSelfSplitFinished == " << TagSelfSplitFinished << std::endl;
}
