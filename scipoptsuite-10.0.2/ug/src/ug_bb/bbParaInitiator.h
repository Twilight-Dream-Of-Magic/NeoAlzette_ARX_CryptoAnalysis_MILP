...
public:
         ...
         )
   {
      if( tightenedVarLbs )
      {
         delete [] tightenedVarLbs;
         tightenedVarLbs = 0;
      }
      if( tightenedVarUbs )
      {
         delete [] tightenedVarUbs;
         tightenedVarUbs = 0;
      }
   }
   ...
   ///
   virtual bool setTightenedVarLbs(
   ...
   /// TODO: this function should be in inherited class
   ///
   virtual bool setTightenedVarUbs(
         int i,          ///< index of variable
         double v        ///< tightened bound
         )
   {
   ...
   /// @return lower bound
   ///
   virtual double getTightenedVarLbs(
         int i            ///< index of variable
         )
   {
      if( tightenedVarLbs )
   ...
   /// @return uppper bound
   ///
   virtual double getTightenedVarUbs(
         int i            ///< index of variable
         )
   {
      if( tightenedVarUbs )
